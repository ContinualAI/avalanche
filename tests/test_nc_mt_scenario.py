...
class MultiTaskTests(unittest.TestCase):
    def test_mt_single_dataset(self):
        ...
        for task_id in range(5):
            self.assertEqual(2, len(my_nc_scenario.classes_in_step[task_id]))
        ...
        for task_id in range(5):
            ...
            all_original_classes.update(
                my_nc_scenario.original_classes_in_step[task_id])
    ...
    def test_mt_single_dataset_without_class_id_remap(self):
        ...
        all_classes = set()
        for task_id in range(my_nc_scenario.n_steps):
            all_classes.update(my_nc_scenario.classes_in_step[task_id])
    ...
    def test_mt_single_dataset_fixed_order(self):
        ...
        all_classes = []
        for task_id in range(5):
            all_classes.extend(my_nc_scenario.classes_in_step[task_id])
    ...
    def test_sit_single_dataset_fixed_subset_no_remap_idx(self):
        ...
        self.assertEqual(2, len(my_nc_scenario.classes_in_step))

        all_classes = set()
        for task_id in range(2):
            self.assertEqual(4, len(my_nc_scenario.classes_in_step[task_id]))
    ...
    def test_mt_multi_dataset_one_task_per_set(self):
        ...
        self.assertTrue(
            (my_nc_scenario.classes_in_step[0] == {0, 1, 2} and
             my_nc_scenario.classes_in_step[1] == set(range(0, 7))) or
            (my_nc_scenario.classes_in_step[0] == set(range(0, 7)) and
