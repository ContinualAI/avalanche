...
Each strategy object offers two main methods `train` and `test`. Both of them, accept either a _single step_ \(`IStepInfo`\) or a _list of them_, for maximum flexibility.
