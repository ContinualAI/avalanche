...
Each strategy object offers two main methods `train` and `eval`. Both of them, accept either a _single experience_ \(`IExperience`\) or a _list of them_, for maximum flexibility.
