...
First of all, [install _Avalanche_ in "_Developer Mode"_](../getting-started-1/1.-how-to-install.md#developer-mode-install) _if you haven't already._ After you've familiarized with the _Avalanche_ codebase you have two roads ahead of you:
