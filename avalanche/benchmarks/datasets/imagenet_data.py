...
IMAGENET_TORCHVISION_CLASSES: List[Tuple[str, ...]] = \
    [('tench', 'Tinca tinca'),
     ...
     ('tree frog', 'tree-frog'),
     ('tailed frog', 'bell toad', 'ribbed toad',
     ...
     ('green mamba',),
     ('sea snake',),
     ('horned viper', 'cerastes', 'sand viper',
     ...
     ('American coot', 'marsh hen', 'mud hen',
     ...
     ('killer whale', 'killer', 'orca', 'grampus',
     ...
     ('standard poodle',),
     ('Mexican hairless',),
     ('timber wolf', 'grey wolf', 'gray wolf',
      'Canis lupus'),
     ('white wolf', 'Arctic wolf',
      'Canis lupus tundrarum'),
     ('red wolf', 'maned wolf', 'Canis rufus',
      'Canis niger'),
     ...
     ('meerkat', 'mierkat'),
     ('tiger beetle',),
     ('ladybug', 'ladybeetle', 'lady beetle',
     ...
     ('breakwater', 'groin', 'groyne', 'mole',
      'bulwark', 'seawall', 'jetty'),
     ...
     ('mountain bike', 'all-terrain bike',
      'off-roader'),
     ('mountain tent',),
...
IMAGENET_TORCHVISION_CLASS_TO_IDX: Dict[str, int] = {
    cls: idx for idx, clss in enumerate(IMAGENET_TORCHVISION_CLASSES)
    for cls in clss}
