...
def create_multi_task_cifar10(incremental_tasks: int,
                              first_task_with_half_classes: bool = False,
                              seed: Optional[int] = None,
                              fixed_class_order: Optional[Sequence[int]] = None
                              ) -> NCMultiTaskScenario:
    """
    Creates a "New Classes - Multi Task" scenario using the CIFAR10 dataset.
    ...
    :param incremental_tasks: The number of incremental tasks in the current
        ...
        first_task_with_half_classes if false, a divisor of 5 (so only 1 or 5)
        otherwise.
    :param first_task_with_half_classes: A boolean value that indicates if a
        ...
        If it's True, a pretrain task with half of the classes (5 for
        cifar10) is used, and a number of incremental tasks, given by the
    ...
    return create_nc_single_dataset_multi_task_scenario(
        ...
        per_task_classes={0: 5} if first_task_with_half_classes else None
    )


def create_single_task_cifar10(incremental_batches: int,
    ...
    :param incremental_batches: The number of incremental batches in the current
        ...
        The value of this parameter should be a divisor of 10 if
        first_batch_with_half_classes if false, a divisor of 5 (so only 1 or 5)
        otherwise.
    :param first_batch_with_half_classes: A boolean value that indicates if a
        ...
        cifar10) is used, and a number of incremental batches, given by the
