...
from .nc_scenario_unified import NCScenarioUnified
...
def create_nc_single_dataset_scenario(
    ...
    :returns: A :class:`NCScenarioUnified` instance.
    """
    ...
    return NCScenarioUnified(train_dataset, test_dataset, n_steps, task_labels,
...
def create_nc_multi_dataset_scenario(
    ...
    return NCScenarioUnified(seq_train_dataset, seq_test_dataset,
                             n_steps,
                             task_labels,
