...
class CUB200_DATA(object):
    """
    CUB200 downloader.
    """

    def __init__(self, data_folder='data/cub200/'):
        """
        Args:
            data_folder (string): folder in which to download CUB200 dataset.
        """
