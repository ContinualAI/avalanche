...
class LRSchedulerPlugin(StrategyPlugin):
    ...
    PyTorch scheduler passed to the constructor. The step() method of the scheduler
    ...
    def __init__(self, scheduler, reset_scheduler=True, reset_lr=True):
        ...
        :param scheduler: a learning rate scheduler that can be updated through a step() method
            and can be reset by setting last_epoch=0
        :param reset_scheduler: If True, the scheduler is reset at the end of the experience.
            Defaults to True.
        :param reset_lr: If True, the optimizer learning rate is reset to its original value.
            Default to True.
        """
        super().__init__()
